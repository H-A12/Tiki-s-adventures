...
Características Principales
    ...
    Dash: Implementación de una mecánica de movilidad avanzada, elevando el techo de habilidad del jugador.
    ...
    Persistencia Remota: Sistema de sincronización de perfiles, moneda interna y estadísticas de sesión mediante una base de datos PostgreSQL.
...
Stack Tecnológico
    ...
    Base de Datos: Remota a través de peticiones HTTPS a nuestra API REST.
