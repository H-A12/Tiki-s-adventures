...
public class PowerUpSystem {
    ...
    private void initPools() {
        ...
        globalPool.add(new MultiStatPowerUp("Máscara rota temerosa", "+7% Robo de vida, +25% Vida máxima y +20% Velocidad de Movimiento", PowerUp.Rarity.LEGENDARIO, thirdTikiLaw));
