...
public enum EffectType {
    ...
    FIRE_PARTICLE("WhiteBullet", 0.9f, 0.35f, false, true, 0f, Color.ORANGE, Color.RED, 0.95f),
    POISON_PARTICLE("GreenBubble", 0.3f, 0.4f, false, true, 0f, Color.LIME, Color.GREEN, 0.95f),
