...
public class Grenade extends Weapon {
    ...
    public Grenade(Entity owner, ProjectileCreator factory, EffectManager effectManager) {
        super(owner, new GrenadeBehavior(factory), effectManager);
        this.sprite = Assets.getRegion("Bomb");
        this.cd = 1f;
        this.shootRange = 12f;
    }

    private static class GrenadeBehavior implements AttackBehavior {
