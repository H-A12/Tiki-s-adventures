...
import com.tikisadventure.ui.UIUtils;
...
public class MenuMapScreen implements Screen {
    ...
    private void crearInterfaz() {
        ...
        for (JsonValue charEntry : characterData.get("characters")) {
            ...
            btn.clearListeners();
            UIUtils.configureActorAnimated(btn, () -> {
        ...
        btnGadget.clearListeners();
        UIUtils.configureActorAnimated(btnGadget, () -> {});
        ...
        btnFlechaAbajo.clearListeners();
        UIUtils.configureActorAnimated(btnFlechaAbajo, this::cambiarSiguienteMapa);

        UIUtils.configureButton(btnJugar, () -> {
            btnJugar.setDisabled(true);
            ejecutarFading(false, () -> game.setScreen(new GameScreen(game)));
        });

        UIUtils.configureButton(btnVolver, () -> {
        ...
        UIUtils.configureButton(btnTienda, () -> {
